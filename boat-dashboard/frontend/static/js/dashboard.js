const gRpm = new RadialGauge(document.getElementById("gauge-rpm"), {
  ...
  zones: [{ from: 4500, to: 5000, color: "#7a2020" }],
});
...
const gOil = new RadialGauge(document.getElementById("gauge-oil"), {
  ...
  zones: [{ from: 0, to: 0.8, color: "#7a2020" }],
});
const gTemp = new RadialGauge(document.getElementById("gauge-temp"), {
  ...
  zones: [{ from: 220, to: 250, color: "#7a2020" }],
});
const gVolt = new RadialGauge(document.getElementById("gauge-volt"), {
  ...
  zones: [{ from: 10, to: 11.5, color: "#7a2020" }, { from: 14.8, to: 16, color: "#7a2020" }],
});
...
const tFuel = new TankBar(document.getElementById("tank-fuel"), { color: "#ffb020" });
const tFresh = new TankBar(document.getElementById("tank-fresh"), { color: "#3ad0ff" });
const tBlack = new TankBar(document.getElementById("tank-black"), { color: "#8a6d4b" });
